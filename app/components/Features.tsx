...
const features = [
  {
    name: "빠른 속도",
    description: "빠른 로딩 시간과 반응성 있는 상호작용을 보장하는 속도 최적화 플랫폼입니다.",
    icon: Zap,
  },
  {
    name: "직관적인 인터페이스",
    description: "탐색이 쉬운 사용자 친화적 인터페이스로 작업 효율성을 높입니다.",
    icon: Layers,
  },
  {
    name: "팀 협업",
    description: "실시간으로 팀원들과 원활하게 협업할 수 있습니다.",
    icon: Users,
  },
  {
    name: "고급 분석",
    description: "강력한 분석 및 보고 도구로 가치 있는 인사이트를 얻을 수 있습니다.",
    icon: TrendingUp,
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="lg:text-center">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            스트림라인은 생산성을 높이고 비즈니스 프로세스를 간소화하도록 설계된 종합적인 기능을 제공합니다.
          </motion.p>
        </div>
